...
This example demonstrates Java 8+ lambda expressions and standard functional interfaces (`Function`, `Predicate`).
...
- `Driver.java`: Assigns and evaluates lambda expressions.
